...
(fn setup [name] ; (local heirline-colors ;        {:oxocarbon {:blue "#82cfff" ;                     :bright_bg "#262626" ;                     :bright_fg "#525252" ;                     :cyan "#3ddbd9" ;                     :dark_red "#ee5396" ;                     :diag_error "#ee5396" ;                     :diag_hint "#78a9ff" ;                     :diag_info "#dde1e6" ;                     :diag_warn "#3ddbd9" ;                     :git_add "#08bdba" ;                     :git_change "#78a9ff" ;                     :git_del "#ee5396" ;                     :gray "#525252" ;                     :green "#42be65" ;                     :orange "" ;                     :purple "#be95ff" ;                     :red "#ff7eb6" ;                     :subtext1 "#525252"}})
  (match name
    :oxocarbon (do
