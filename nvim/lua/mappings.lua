...
local mappings = {
	...
	l = {
		...
		d = { "Telesope lsp_definitions", "Go To Definition" },
		D = { "Telesope lsp_declarations", "Go To Declaration" },
		r = { "Telesope lsp_references", "Go To References" },
		I = { "Telesope lsp_implementations", "Go To References" },
		t = { "Telesope lsp_type_definitions", "Go To References" },
