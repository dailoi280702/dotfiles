...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'tabline.nvim', 'AutoSave.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'nvim-ts-rainbow'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
