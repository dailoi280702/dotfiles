if &background == 'dark'
  let s:guishade0 = "#1F1913"
  let s:guishade1 = "#3F3A30"
  let s:guishade2 = "#5F5A4D"
  let s:guishade3 = "#7F7B6A"
  let s:guishade4 = "#9E9C86"
  let s:guishade5 = "#BEBDA3"
  let s:guishade6 = "#DEDDC0"
  let s:guishade7 = "#FEFEDD"
  let s:guiaccent0 = "#994643"
  let s:guiaccent1 = "#F2AB71"
  let s:guiaccent2 = "#FFCF86"
  let s:guiaccent3 = "#4B8075"
  let s:guiaccent4 = "#639587"
  let s:guiaccent5 = "#517665"
  let s:guiaccent6 = "#8B596A"
  let s:guiaccent7 = "#8E5252"
  let s:ctermshade0 = 52
...
highlight clear
syntax reset
let g:colors_name = "ThemerGreenAsAWhistle"
